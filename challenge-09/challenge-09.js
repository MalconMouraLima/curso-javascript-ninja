(function(){
    ...
    */
    var subtraction = calculator(15 , 3);
    var multiplication = calculator(7, 9);
    var division = calculator(360, 60);
    var mod = calculator(121, 2);
