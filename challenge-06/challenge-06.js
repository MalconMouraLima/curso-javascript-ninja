...
*/
let championship = 'Campeonato Italiano';
...
desafio.
*/
let teams = ['Roma', 'Inter de Milão', 'Milan', 'Juventus', 'Napoli'];
...
*/
console.log(showTeamPosition(5)); // O time que está em 5 º lugar é o Napoli.
console.log(showTeamPosition(2)); // O time que está em 2 º lugar é o Inter de Milão.
console.log(showTeamPosition(7)); // Não temos a informação do time que está nessa posição. 
console.log(showTeamPosition(3)); // O time que está em 3 º lugar é o Milan.
console.log(showTeamPosition(1)); // O time que está em 1 º lugar é o Roma.
